...
from Presentation.frames.account_management import AccountManagmentFrame
from Presentation.frames.reset_password import ResetPasswordFrame
from Presentation.frames.my_profile import MyProfileFrame
from Presentation.frames.transaction_manajement import TransactionManajementFrame
from Presentation.frames.create_transaction import CreateTransation
from Presentation.frames.create_customer import CreateCustomerFrame
from Presentation.frames.admin_home import AdminHomeFrame
from Presentation.frames.employee_request_approval import EmployeeRequestApprovalFrame
from Presentation.frames.employee_management import EmployeeManagmentFrame
from Presentation.frames.update_employee import UpdateEmployeeFrame
from Presentation.frames.customer_management import CustomerManagementFrame
from Presentation.frames.deactivated_employees import DeactivatedEmployeeFrame
from Presentation.frames.update_customer import UpdateCustomerFrame
from Presentation.frames.rejected_employees import RejectEmployeeFrame
from Presentation.frames.customer_accounts import CustomerAccountsFrame
from .frames.update_account import UpdateAccountFrame
from Presentation.frames.admin_reset_Employee_Password import AdminResetEmployeePasswordFrame
from Presentation.frames.request_employee import RequestEmployeeFrame
from Presentation.frames.navbar import Navbar
...
class ViewManager:
    def __init__(self,employee_business:EmployeeBusinessLogic,
        ...
        self.add_frame("create transation",CreateTransation(self.window,self,transaction_business),(500,350))
        ...
        self.add_frame("Home", HomeFrame(self.window, self), (390, 400))
        self.add_frame("home admin", AdminHomeFrame(self.window, self), (390, 400))
